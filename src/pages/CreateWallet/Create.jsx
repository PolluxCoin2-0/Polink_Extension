...
//   useEffect(() => {
//     if (dataObj) {
//       setWalletName(dataObj?.WalletName);
//       setPassword(dataObj?.password);
//       setConfirmPassword(dataObj?.password);
//     }
//   }, [dataObj]);
...
//       // Generate wallet data using generateKeys if no dataObj is provided
...
//       localStorage.setItem(walletName, JSON.stringify(newDataObj));
