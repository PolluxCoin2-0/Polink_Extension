...
//                     <div>
//                         <h1 className="text-[18px] text-black font-semibold">Hi, {walletName}</h1>
            ...
            <div className="bg-gradient-to-b from-[#ffff] to-[#FFDF84] w-[350px] h-[224px] text-white rounded-b-[40px] p-6">
                ...
                <div className="flex justify-center gap-2 items-center">
                    ...
                    <button onClick={() => setIsHidden(!isHidden)}>
                        {isHidden ? <IoEyeOff color="black" /> : <IoEye color="black" />}
                    </button>
                </div>

                <div className="flex justify-center gap-2 items-center">
                    <p className="text-[22px] text-black font-black">
                        {isHidden ? "****" : "800000.32"}
                    </p>
            ...
            {showAssets && (
                <div className="p-4 space-y-2">
                    <div className="text-black bg-white rounded-xl px-4">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center mt-2 space-x-2">
                                <img src="../images/poxtoken.svg" alt="POX" className="w-10 h-10 mt-[1px]" />
                                <div className="text-left">
                                    <p className="text-[14px] font-semibold">POX</p>
                                    <p className="text-[12px] text-gray-400">$2.1834</p>
                                </div>
                    ...
                    <div className="text-black bg-white rounded-xl px-4">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center mt-2 space-x-2">
                                <img src="../images/usdxtoken.svg" alt="USDX" className="w-10 h-10 mt-[1px]" />
                                <div className="text-left">
                                    <p className="text-[14px] font-semibold">USDX</p>
                                    <p className="text-[12px] text-gray-400">$2.1830</p>
                                </div>
